...
%Independently of our work \cite{pham2013dropout} developed the very the same method
%of RNN regularization, and they demonstrate its application 
%in handwriting recognition. By the time of publishing of this paper, we were not aware
%of existence such publication. Our work rediscovers RNN regularization and shows
