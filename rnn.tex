...
We will describe here two justifications why putting dropout across recurrent layers helps,
but within layers degradate performance. 


Dropout removes part of information, and target function approximator has to become
...
$39$ epochs, starting with learning rate $1$, and after $6$ epochs we descrese it by $1.2$ 
